...
4. **Mount new modules** in `deploy/docker-compose.yml` *and* `deploy/Dockerfile`,
...
- Stack: Odoo 19 · Python 3.12 · PostgreSQL 16. Run with `docker compose -f deploy/docker-compose.yml up -d` → http://localhost:8069.
